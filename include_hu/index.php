...
<head>
	...
	<title>A mappa fájljai listája</title>
</head>
<body>

<h2>A mappa fájljai listája <tt>include</tt></h2>
...
$path = "/data/www/www.breviar.sk/public_html/include_hu/";
...
//print
echo "\n<table>";
echo "\n<tr><th>fájl</th><th>utolsó változás</th></tr>";
foreach($content_array as $res)
