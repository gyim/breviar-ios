...
let CalendarNames: [String: String] = [
    ...
    "opraem": "pro premonstráty (OPraem)",
    "ofmcap": "pro kapucíny (OFMCap.)",
    "czsdb": "pro salesiánskou rodinu",
    "czofm": "pro františkány (OFM)",
    "czsj": "pro jezuity (SJ)",
    "czocd": "pro bosé karmelitány (OCD)",
    "czofmconv": "pro minority (OFMConv)",
    "czocarm": "pro karmelitány (O.Carm.)",

    // Hungarian
    "hu": "általános [Magyarország]",
    "huofm": "ferences zsolozsmája",
    "husvd": "verbiták zsolozsmája (SVD)",
    "husj": "jezsuiták zsolozsmája (SJ)",
    "husdb": "szalézi zsolozsma",
    "huschp": "piaristák zsolozsmája (SchP)",

    // Slovak
    "sk": "všeobecný [pre Slovensko]",
    "cssr": "pre redemptoristov (CSsR)",
    "svd": "pre verbistov (SVD)",
    "ofm": "pre františkánsku rodinu",
    "sdb": "pre saleziánsku rodinu",
    "op": "pre dominikánov (OP)",
    "sj": "pre jezuitov (SJ)",
    "cm": "pre lazaristov (CM)",
    "ocd": "pre bosých karmelitánov (OCD)",
    "csa": "pre kanonisky Notre Dame (CSA)",
    "osu": "pre uršulínky (OSU)",
    "skopraem": "pre premonštrátov (OPraem)",
    "schp": "pre piaristov (SchP)",
