...
void prilep_request_options(char pom2 [MAX_STR], char pom3 [MAX_STR], short int prvy_ampersand){
	...
	/* 2011-05-06: pridané odovzdanie parametra pre font */
	...
	/* 2011-05-13: pridané odovzdanie parametra pre font size */
