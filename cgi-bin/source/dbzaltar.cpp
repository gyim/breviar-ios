...
*/
		...
		case MES_JUL:
			switch(den){
				...
				case 4: /* MES_JUL */
					if(_global_jazyk == JAZYK_SK){
						/* 2009-07-09: odvetvenÈ len pre SK */
						if(poradie_svaty == 1){
							/* definovanie parametrov pre modlitbu */
				...
				case 20: /* MES_JUL */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						_global_svaty1.smer = 11; /* povinne spomienky podla vseobecneho kalendara - zmenenÈ na æubovoænÈ */
						mystrcpy(_global_svaty1.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
						strcat(_global_svaty1.meno, text_JUL_20[_global_jazyk]);
						_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_MUCENIK, MODL_SPOL_CAST_DUCH_PAST_BISKUP);
						_global_svaty1.farba = LIT_FARBA_CERVENA;
					}
					break;
				...
				case 31: /* MES_JUL */
					if(poradie_svaty == 1){
						...
						modlitba = MODL_RANNE_CHVALY;
						if(_global_jazyk == JAZYK_SK) // v slovenskom brevi·ri m· vlastn˝ hymnus, v Ëeskom nie; 2008-09-09
							_vlastna_cast_hymnus;
						_vlastna_cast_benediktus;
						_vlastna_cast_modlitba;
			...
			switch(den){
				case 3: /* MES_SEP */
					if(poradie_svaty == 1){
						...
						modlitba = MODL_RANNE_CHVALY;
						if(_global_jazyk == JAZYK_SK) // v slovenskom brevi·ri m· vlastn˝ hymnus, v Ëeskom nie; 2008-09-10
							_vlastna_cast_hymnus;
						_vlastna_cast_benediktus;
						_vlastna_cast_modlitba;
				...
				case 12: /* MES_SEP */
					...
					if(poradie_svaty == 1){
						...
						if(_global_jazyk == JAZYK_SK){ /* 2009-07-10: pre ËeskÈ brevi·re vöetko zo spoloËnej Ëasti */
							modlitba = MODL_RANNE_CHVALY;
							_vlastna_cast_modlitba;
