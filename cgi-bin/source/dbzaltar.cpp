...
void set_hymnus(short int den, short int tyzzal, short int modlitba){
	...
	/* toto vöak neplatÌ pre Ëesk˝ dominik·nsk˝ brevi·¯, 2008-12-16 */
	/* pre advent II. je predpÌsan˝ hymnus, 2008-12-17 */
...
void zaltar_kompletorium(short int den, short int obdobie, short int specialne){
	...
	if(specialne == ZALTAR_VSETKO){
		...
		/* pridanÈ Ëasti pre kompletÛrium, 2006-10-13 */
		set_hymnus(den, 1 /* tyzzal */, MODL_KOMPLETORIUM);
		set_hymnus(den, 1 /* tyzzal */, MODL_PRVE_KOMPLETORIUM);
...
void zaltar_zvazok(short int den, short int tyzzal, short int obdobie, short int specialne){
	...
	*/
	...
	zaltar_kompletorium(den, obdobie, specialne);
			...
			switch(den){
				...
				case 18: /* MES_JAN */
					...
					if((_global_jazyk == JAZYK_CZ) || (_global_jazyk == JAZYK_CZ_OP)){
						if(poradie_svaty == 1){
							/* definovanie parametrov pre modlitbu */
							if(query_type != PRM_DETAILY)
								set_spolocna_cast(sc, poradie_svaty, ANO, ANO, ANO, NIE, NIE);
				...
				case 19: /* MES_JAN */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						_global_svaty1.typslav = SLAV_SPOMIENKA;
						_global_svaty1.smer = 10; /* povinne spomienky podla vseobecneho kalendara */
						mystrcpy(_global_svaty1.meno, text_JAN_19[_global_jazyk], MENO_SVIATKU);
			...
			switch(den){
				...
				case 4: /* MES_FEB */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						_global_svaty1.typslav = SLAV_SPOMIENKA;
						_global_svaty1.smer = 10; /* povinne spomienky podla vseobecneho kalendara */
						mystrcpy(_global_svaty1.meno, text_FEB_04[_global_jazyk], MENO_SVIATKU);
						_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_PANNA, MODL_SPOL_CAST_SV_ZENA_REHOLNIK);
						_global_svaty1.farba = LIT_FARBA_BIELA;
					}
					break;
				...
				case 12: /* MES_FEB */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						_global_svaty1.typslav = SLAV_LUB_SPOMIENKA;
						_global_svaty1.smer = 12; /* lubovolne spomienky podla vseobecneho kalendara */
						mystrcpy(_global_svaty1.meno, text_FEB_12[_global_jazyk], MENO_SVIATKU);
						_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_DUCH_PAST_KNAZ);
						_global_svaty1.farba = LIT_FARBA_BIELA;
					}
					break;
				case 13: /* MES_FEB */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						_global_svaty1.typslav = SLAV_SPOMIENKA;
						_global_svaty1.smer = 10; /* povinne spomienky podla vseobecneho kalendara */
						mystrcpy(_global_svaty1.meno, text_FEB_13[_global_jazyk], MENO_SVIATKU);
						_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_DUCH_PAST_KNAZ);
						_global_svaty1.farba = LIT_FARBA_BIELA;
					}
					break;
				...
				case 18: /* MES_FEB */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						_global_svaty1.typslav = SLAV_LUB_SPOMIENKA;
						_global_svaty1.smer = 12; /* lubovolne spomienky podla vseobecneho kalendara */
						mystrcpy(_global_svaty1.meno, text_FEB_18[_global_jazyk], MENO_SVIATKU);
						_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_DUCH_PAST_KNAZ);
						_global_svaty1.farba = LIT_FARBA_BIELA;
					}
					break;
			...
			switch(den){
				...
				case 8: /* MES_MAR */
					...
					if(_global_jazyk == JAZYK_SK){ /* 2010-03-16: pridanÈ len pre Slovensko */
						...
						pocet = 2;
						_global_svaty2.smer = 8; /* mieste sviatky */
			...
			switch(den){
				...
				case 20: /* MES_APR */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						_global_svaty1.typslav = SLAV_SPOMIENKA;
						_global_svaty1.smer = 12; /* povinne spomienky podla vseobecneho kalendara; 10 -> 12; 2010-03-15 */
			...
			switch(den){
				...
				case 5: /* MES_MAY */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						_global_svaty1.typslav = SLAV_SPOMIENKA;
						_global_svaty1.smer = 12; /* lubovolne spomienky podla vseobecneho kalendara - kvÙli tomu, aby bolo aj "zo dÚa" */
						mystrcpy(_global_svaty1.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
				...
				case 14: /* MES_MAY */
					if(poradie_svaty == 1){
						...
						/* 2008-05-14: doplnenÈ podæa 3. m·ja; 2009-10-21: upravenÈ */
						_vlastna_cast_mcd_kcitresp_modl;
				...
				case 15: /* MES_MAY */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						_global_svaty1.typslav = SLAV_SPOMIENKA;
						_global_svaty1.smer = 11; /* povinne spomienky podla vseobecneho kalendara - zmenenÈ na æubovoænÈ */
						mystrcpy(_global_svaty1.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
				...
				case 21: /* MES_MAY */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						_global_svaty2.smer = 12; /* povinne spomienky podla vseobecneho kalendara - nastavenÈ ako æubovoæn·*/
						mystrcpy(_global_svaty2.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
			...
			switch(den){
				...
				case 3: /* MES_JUL */
					if(poradie_svaty == 1){
						...
						/* 2009-08-17: doplnenÈ kr·tke ËÌtanie zo spol. Ëasti; modlitba ako na rannÈ chv·ly; 2009-10-21: upravenÈ; doplnenÈ kr·tke resp. */
						_vlastna_cast_mcd_kcitresp_modl;
				...
				case 17: /* MES_JUL */
					if(_global_jazyk == JAZYK_SK){
						...
						if(_global_jazyk == JAZYK_CZ_OP){
							...
							_global_svaty1.smer = 11; /* povinne spomienky podla vseobecneho kalendara - zmenenÈ na æubovoænÈ */
							mystrcpy(_global_svaty1.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
							strcat(_global_svaty1.meno, text_JUL_17_3[_global_jazyk]);
							_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_DUCH_PAST_KNAZ);
						}
						else{
							_global_svaty1.typslav = SLAV_LUB_SPOMIENKA;
				...
				case 25: /* MES_JUL */
					if(poradie_svaty == 1){
						...
						/* 2009-07-30: doplnenÈ kr·tke ËÌtanie zo spol. Ëasti; 2009-10-21: doplnenÈ mcd in·Ë ako bolo d·vnejöie */
						_vlastna_cast_mcd_kcitresp_modl;
			...
			switch(den){
				...
				case 23: /* MES_AUG */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						/* 2009-07-10: odvetvenÈ pre dominik·nov */
						mystrcpy(_global_svaty1.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
						strcat(_global_svaty1.meno, text_AUG_23[_global_jazyk]);
					}
					else{
						_global_svaty1.typslav = SLAV_LUB_SPOMIENKA;
						_global_svaty1.smer = 12; /* lubovolne spomienky podla vseobecneho kalendara */
				...
				case 15: /* MES_SEP */
					...
					if(((poradie_svaty == UNKNOWN_PORADIE_SVATEHO) && (_global_jazyk == JAZYK_SK)) || (poradie_svaty == 1)){
						...
						if(/*(poradie_svaty == 1) && */ // 23/02/2000A.D.; zobrate z 8.dec; 28/03/2000A.D.
						  (query_type != PRM_DETAILY))
							set_spolocna_cast(sc, poradie_svaty, ANO, ANO, ANO, ANO, ANO); /* 2009-12-15: ber˙ sa vöetky veci zo spol. Ëasti; kvÙli prosb·m zo spol. Ëasti */
				...
				case 28: /* MES_SEP */
					if((_global_jazyk == JAZYK_CZ) || (_global_jazyk == JAZYK_CZ_OP)){ /* 2008-10-09: odvetvenÈ len pre »esko; prevzatÈ podæa cyrila a metoda */
						...
						if((poradie_svaty == UNKNOWN_PORADIE_SVATEHO) || (poradie_svaty == 1)){
							...
							if(query_type != PRM_DETAILY)
								set_spolocna_cast(sc, poradie_svaty, ANO, ANO, ANO, ANO, ANO); /* 2009-10-12: ber˙ sa vöetky veci zo spol. Ëasti */
			...
			switch(den){
				...
				case 7: /* MES_OCT */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						/* 2009-07-10: odvetvenÈ pre dominik·nov */
						mystrcpy(_global_svaty1.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
						strcat(_global_svaty1.meno, text_OKT_07[_global_jazyk]);
					}
					else{
						_global_svaty1.typslav = SLAV_SPOMIENKA;
						_global_svaty1.smer = 10; /* povinne spomienky podla vseobecneho kalendara */
				...
				case 9: /* MES_OCT */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						pocet = 3;
						_global_svaty3.typslav = SLAV_SPOMIENKA;
						_global_svaty3.smer = 12; /* povinne spomienky podla vseobecneho kalendara upravenÈ na æubovoæn˙ */
						mystrcpy(_global_svaty3.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
				...
				case 13: /* MES_NOV */
					if((_global_jazyk == JAZYK_CZ) || (_global_jazyk == JAZYK_CZ_OP)){
						if(poradie_svaty == 1){
							/* definovanie parametrov pre modlitbu */
							if(query_type != PRM_DETAILY)
								set_spolocna_cast(sc, poradie_svaty, ANO, ANO, ANO, ANO, ANO); /* 2009-12-08: ber˙ sa vöetky veci zo spol. Ëasti; je to spomienka */
...
label_8_DEC:
				...
				case 27: /* MES_DEC */
					if(poradie_svaty == 1){
						...
						/* modlitba cez deÚ, pridanÈ 2006-02-05; 2009-10-21: upravenÈ */
						_vlastna_cast_mcd_kcitresp_modl;
