...
void _set_zalmy_vian_oktava(int den, int modlitba){
 ...
 */
void _set_zalmy_sviatok_jana_ap(int modlitba){
...
/* switch(litobd), case OBD_VIANOCNE_I -- begin ----------------------------------------------- */
		...
		/* 2006-01-24: tu zaËÌna VIANO»N… OBDOBIE I. */
			...
			if((_global_den.den == 26) || (_global_den.den == 27) || (_global_den.den == 28)){
				...
				/* posv‰tnÈ ËÌtanie; 2006-02-04; eöte nie ˙plne dokonËenÈ */
				modlitba = MODL_POSV_CITANIE;
				_vian1_hymnus;
