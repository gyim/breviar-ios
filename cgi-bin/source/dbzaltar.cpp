...
void liturgicke_obdobie(short int litobd, short int tyzden, short int den, short int tyzzal, short int poradie_svateho){
	...
	/* if((_global_den.smer > 5) || (_global_den.smer == 2)) */
	  ...
	  * 2009-03-27: doplnen˝ aj sviatok - v˝roËie posviacky later·nskej baziliky, ak padne na nedeæu (niûöie)
	  */
	...
	/* 2009-03-27: doplnen˝ aj sviatok - v˝roËie posviacky later·nskej baziliky, ak padne na nedeæu */
	if((_global_den.den == 9) && (_global_den.mesiac - 1 == MES_NOV) && (_global_den.denvt == DEN_NEDELA)){
		Log("v˝roËie posviacky later·nskej baziliky, ak padne na nedeæu - netreba ûalt·r... (bud˙ aj prvÈ veöpery)\n");
	}
	else{
			...
			switch(den){
				...
				case 26: /* MES_SEP */
					...
					if(_global_jazyk != JAZYK_CZ_OP){
						...
						_global_svaty1.typslav = SLAV_SPOMIENKA;
						_global_svaty1.smer = 10; /* povinne spomienky podla vseobecneho kalendara */
						mystrcpy(_global_svaty1.meno, text_SEP_26_2[_global_jazyk], MENO_SVIATKU);
						_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_VIAC_MUCENIKOV);
						_global_svaty1.farba = LIT_FARBA_CERVENA; /* 2006-08-19: pridanÈ */
					}
					break;
			...
			switch(den){
				...
				case 9: /* MES_OCT */
					...
					if(_global_jazyk != JAZYK_CZ_OP){
						...
						_global_svaty1.typslav = SLAV_SPOMIENKA;
						_global_svaty1.smer = 10; /* povinne spomienky podla vseobecneho kalendara */
						mystrcpy(_global_svaty1.meno, text_OKT_09_3[_global_jazyk], MENO_SVIATKU);
						_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_DUCH_PAST_KNAZ);
						_global_svaty1.farba = LIT_FARBA_BIELA;
					}
					break;
