		...
		case MES_JUN:
			switch(den){
				...
				case 6:
					...
					_global_svaty1.typslav = SLAV_SPOMIENKA;
					_global_svaty1.smer = 10; /* od 29.8.1991 pam·tka */
				...
				case 19:
					if(_global_jazyk == JAZYK_SK){ /* 2006-09-12: odvetvenÈ */
						...
						_global_svaty1.typslav = SLAV_SPOMIENKA;
						_global_svaty1.smer = 10;
						/* _global_svaty1.typslav_lokal = LOKAL_SLAV_CESKOBUD_SPOMIENKA; */
				...
				case 30:
					...
					if(_global_jazyk == JAZYK_CZ){
						...
						_global_svaty2.typslav_lokal = LOKAL_SLAV_OLOMOUC_SVIATOK;
			...
			switch(den){
				...
				case 16:
					...
					if(_global_jazyk == JAZYK_CZ){
						...
						_global_svaty2.typslav = SLAV_LUB_SPOMIENKA;
						_global_svaty2.smer = 12; /* lubovolne spomienky podla vseobecneho kalendara */
						_global_svaty2.typslav_lokal = LOKAL_SLAV_OSTRAVA_OPAVA_SVIATOK;
		...
		case MES_OCT:
			switch(den){
				...
				case 15:
					...
					break;
				case 16:
					if(_global_jazyk == JAZYK_CZ){ /* 2006-09-13: odvetvenÈ pre »esko */
						if(poradie_svaty == 1){
							/* definovanie parametrov pre modlitbu */
						...
						_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_SV_ZENA_SKUTKYMIL, MODL_SPOL_CAST_SV_ZENA_REHOLNIK, MODL_SPOL_CAST_SV_ZENA_MANZ /* 2006-08-07: doplnenÈ */);
						_global_svaty1.farba = LIT_FARBA_BIELA; /* 2006-08-19: pridanÈ */
					}
					else if(_global_jazyk == JAZYK_SK){ /* 2006-09-13: odvetvenÈ pre Slovensko */
						if(poradie_svaty == 1){
							/* definovanie parametrov pre modlitbu */
