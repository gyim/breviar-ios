			...
			switch(den){
				...
				case 13: /* MES_FEB */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						_global_svaty1.typslav = SLAV_SPOMIENKA;
						_global_svaty1.smer = 12; /* povinne spomienky podla vseobecneho kalendara; 10 -> 12; 2010-07-06 podæa 2010-03-15 */
						mystrcpy(_global_svaty1.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
				...
				case 17: /* MES_JUL */
					if(_global_jazyk == JAZYK_SK){
						...
						if(_global_jazyk == JAZYK_CZ_OP){
							...
							pocet = 2;
							_global_svaty2.typslav = SLAV_SPOMIENKA;
							_global_svaty2.smer = 11; /* povinne spomienky podla vseobecneho kalendara - zmenenÈ na æubovoænÈ */
							mystrcpy(_global_svaty2.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
