...
void set_hymnus_kompletorium_obd(short int den, short int tyzzal, short int modlitba, short int litobd){
	...
	/* 2008-12-11: pre dominik·nsky rovnako ako pre slovensk˝, teda jeden hymnus VN */
	...
	switch(den){
		case DEN_NEDELA:
			...
			if((tyzzal == 1) || (tyzzal == 3)){
				set_zalm(2, MODL_RANNE_CHVALY, "dan3_57.htm", "DAN3,57-88.56");
				/* modlitba cez den */
				...
				*/
				...
				set_zalm(2, MODL_RANNE_CHVALY, "dan3_52.htm", "DAN3,52-57");
			...
			set_zalm(3, MODL_PRVE_VESPERY, "flp2.htm", "CHVAL_FLP2");
			if((_global_den.litobd != OBD_POSTNE_I) &&
				(_global_den.litobd != OBD_POSTNE_II_VELKY_TYZDEN)){
					set_zalm(3, MODL_VESPERY, "zjv19.htm", "CHVAL_ZJV19");
			}
			else{
				set_zalm(3, MODL_VESPERY, "1pt2.htm", "CHVAL_1PT2");
			}
			break;
		/* vecerny hymnus vsedneho dna je rovnaky v kazdom tyzdni */
		case DEN_PONDELOK:
			set_zalm(3, MODL_VESPERY, "ef1.htm", "CHVAL_EF1");
			break;
		case DEN_UTOROK:
			set_zalm(3, MODL_VESPERY, "zjv4_5.htm", "CHVAL_ZJV45");
			break;
		case DEN_STREDA:
			set_zalm(3, MODL_VESPERY, "kol1.htm", "CHVAL_KOL1");
			break;
		case DEN_STVRTOK:
			set_zalm(3, MODL_VESPERY, "zjv11.htm", "CHVAL_ZJV11");
			break;
		case DEN_PIATOK:
			/* kazdy piatok, ranne chvaly je zalm 51 */
			set_zalm(1, MODL_RANNE_CHVALY, "z51.htm", "ZALM51");
			set_zalm(3, MODL_VESPERY, "zjv15.htm", "CHVAL_ZJV15");
			break;
		case DEN_SOBOTA:
		...
		case 1: /* prvy tyzden zaltara */
			switch(den){
				...
				/* ranne chvaly */
					...
					set_zalm(2, MODL_RANNE_CHVALY, "1krn29.htm", "CHVAL_1KRN29");
				...
				/* ranne chvaly */
					...
					set_zalm(2, MODL_RANNE_CHVALY, "tob13.htm", "CHVAL_TOB13,2-8");
				...
				/* ranne chvaly */
					...
					set_zalm(2, MODL_RANNE_CHVALY, "jdt16.htm", "CHVAL_JDT16");
				...
				/* ranne chvaly */
					...
					set_zalm(2, MODL_RANNE_CHVALY, "jer31.htm", "CHVAL_JER31");
				...
				case DEN_PIATOK:
				/* ranne chvaly */
					set_zalm(2, MODL_RANNE_CHVALY, "iz45.htm", "CHVAL_IZ45");
				...
				/* ranne chvaly */
					...
					set_zalm(2, MODL_RANNE_CHVALY, "ex15.htm", "CHVAL_EX15");
		...
		case 2: /* druhy tyzden zaltara */
			switch(den){
				...
				/* ranne chvaly */
					...
					set_zalm(2, MODL_RANNE_CHVALY, "sir36.htm", "CHVAL_SIR36");
				...
				/* ranne chvaly */
					...
					set_zalm(2, MODL_RANNE_CHVALY, "iz38.htm", "CHVAL_IZ38");
				...
				/* ranne chvaly */
					...
					set_zalm(2, MODL_RANNE_CHVALY, "1sam2.htm", "CHVAL_1SAM2");
				...
				/* ranne chvaly */
					...
					set_zalm(2, MODL_RANNE_CHVALY, "iz12.htm", "CHVAL_IZ12");
				...
				case DEN_PIATOK:
				/* ranne chvaly */
					set_zalm(2, MODL_RANNE_CHVALY, "hab3.htm", "CHVAL_HAB3");
				...
				/* ranne chvaly */
					...
					set_zalm(2, MODL_RANNE_CHVALY, "dt32.htm", "CHVAL_DT32");
		...
		case 3: /* treti tyzden zaltara */
			switch(den){
				...
				/* ranne chvaly */
					...
					set_zalm(2, MODL_RANNE_CHVALY, "iz2.htm", "CHVAL_IZ2");
				...
				/* ranne chvaly */
					...
					set_zalm(2, MODL_RANNE_CHVALY, "iz26.htm", "CHVAL_IZ26");
				...
				/* ranne chvaly */
					...
					set_zalm(2, MODL_RANNE_CHVALY, "iz33.htm", "CHVAL_IZ33");
				...
				/* ranne chvaly */
					...
					set_zalm(2, MODL_RANNE_CHVALY, "iz40.htm", "CHVAL_IZ40");
				...
				case DEN_PIATOK:
				/* ranne chvaly */
					set_zalm(2, MODL_RANNE_CHVALY, "jer14.htm", "CHVAL_JER14");
					set_zalm(3, MODL_RANNE_CHVALY, "z100.htm", "ZALM100");
				/* modlitba cez den */
				...
				/* ranne chvaly */
					set_zalm(1, MODL_RANNE_CHVALY, "z119.htm", "ZALM119_KOF");
					set_zalm(2, MODL_RANNE_CHVALY, "mud9.htm", "CHVAL_MUD9");
					set_zalm(3, MODL_RANNE_CHVALY, "z117.htm", "ZALM117");
				/* modlitba cez den */
		...
		case 4: /* stvrty tyzden zaltara */
			switch(den){
				...
				/* ranne chvaly */
					...
					set_zalm(2, MODL_RANNE_CHVALY, "iz42.htm", "CHVAL_IZ42");
				...
				/* ranne chvaly */
					...
					set_zalm(2, MODL_RANNE_CHVALY, "dan3_26.htm", "CHVAL_DAN3,26");
				...
				/* ranne chvaly */
					...
					set_zalm(2, MODL_RANNE_CHVALY, "iz61.htm", "CHVAL_IZ61");
				...
				/* ranne chvaly */
					...
					set_zalm(2, MODL_RANNE_CHVALY, "iz66.htm", "CHVAL_IZ66");
				...
				case DEN_PIATOK:
				/* ranne chvaly */
					set_zalm(2, MODL_RANNE_CHVALY, "tob13.htm", "CHVAL_TOB13,8-11");
					set_zalm(3, MODL_RANNE_CHVALY, "z147.htm", "ZALM147,12-20");
				/* modlitba cez den */
				...
				/* ranne chvaly */
					set_zalm(1, MODL_RANNE_CHVALY, "z92.htm", "ZALM92");
					set_zalm(2, MODL_RANNE_CHVALY, "ez36.htm", "CHVAL_EZ36");
					set_zalm(3, MODL_RANNE_CHVALY, "z8.htm", "ZALM8");
				/* modlitba cez den */
...
void _set_zalmy_biela_sobota(short int modlitba){
	...
	if(modlitba == MODL_VESPERY){
		...
		set_zalm(2, modlitba, "iz38.htm", "CHVAL_IZ38");
...
void _set_zalmy_1nedele_v_pre_1v(void){/* ûalmy a chv·lospev z veöpier pre prvÈ veöpery -- kvÙli druhej veækonoËnej nedeli; 2008-04-04 */
	...
	set_zalm(3, MODL_PRVE_VESPERY, "zjv19.htm", "CHVAL_ZJV19");
...
void _set_zalmy_posviacka_chramu(short int modlitba){
	...
	if(modlitba == MODL_VESPERY){
		...
		if((_global_den.litobd == OBD_POSTNE_I) || (_global_den.litobd == OBD_POSTNE_II_VELKY_TYZDEN))
			set_zalm(3, modlitba, "zjv15.htm", "CHVAL_ZJV15");
		else
			set_zalm(3, modlitba, "zjv19.htm", "CHVAL_ZJV19");
	}
	else if(modlitba == MODL_RANNE_CHVALY){
...
void _set_zalmy_nanebovstupenie(short int modlitba){
	...
	if(modlitba == MODL_VESPERY){
		...
		set_zalm(3, modlitba, "zjv11.htm", "CHVAL_ZJV11");
	}
	else if(modlitba == MODL_PRVE_VESPERY){
...
void _set_zalmy_najsv_trojice(short int modlitba){
	...
	if(modlitba == MODL_VESPERY){
		...
		set_zalm(1, modlitba, "z113.htm", "ZALM113");
		set_zalm(2, modlitba, "z147.htm", "ZALM147,12-20");
		set_zalm(3, modlitba, "ef1.htm", "CHVAL_EF1");
	}
	else if(modlitba == MODL_POSV_CITANIE){
		set_zalm(1, modlitba, "z8.htm", "ZALM8");
...
void _set_zalmy_zjv(short int modlitba){
	...
	if(modlitba == MODL_VESPERY){
		...
		set_zalm(3, modlitba, "1tim3.htm", "CHVAL_1TIM3");
	}
...
void _set_zalmy_sviatok_muc(short int modlitba){
	...
	if(modlitba == MODL_VESPERY){
		...
		set_zalm(3, modlitba, "1pt2.htm", "CHVAL_1PT2");
	}
	else if(modlitba == MODL_POSV_CITANIE){
		set_zalm(1, modlitba, "z2.htm", "ZALM2");
...
void _set_spolocna_cast(short int a, _struct_sc sc
	...
	/* spolocna cast na sviatky duchovnych pastierov */
		...
		/* prvÈ veöpery */
		modlitba = MODL_PRVE_VESPERY;
		if(su_zalmy_prve_vespery_vlastne || (_global_opt2 == MODL_ZALMY_ZO_SV) || brat_zalmy == ANO){ /* 2006-02-04_ZALMY_ZO_SVIATKU_FIX; 2010-06-04/2009-09-18: doplnenÈ brat_zalmy */
...
// 2006-01-19_LABEL // 2005-08-16: tu treba pokraËovaù
	...
	/* spolocna cast na oficium za zosnulych */
		...
		Log("/* upravenÈ tak, ûe spoloËn· Ëasù na ofÌcium za zosnul˝ch vûdy berie vlastnÈ ûalmy; vraciam sp‰ù nastavenie _global_opt2 */\n");
...
void set_spolocna_cast(_struct_sc sc, short int poradie_svaty
	...
	if(sc.a1 != MODL_SPOL_CAST_NEURCENA){
		if(_global_opt3 == sc.a1){
			...
			_set_spolocna_cast(_global_opt3, brat_antifony, brat_zalmy, brat_1citanie, brat_kresp_prosby, brat_2citanie, brat_antifony_mcd);
		}
		else{
			Log("	neplatÌ _global_opt3 == sc.a1 ...\n");
		...
		case MES_JAN:
			switch(den){
				case 2: /* MES_JAN */
					...
					break;
				case 3: /* MES_JAN */
					/* 2008-12-04: pridanÈ pre czop; 2009-03-24: zmenenÈ aj pre ostatnÈ, pretoûe je to vo vöeobecnom kalend·ri */
					if(poradie_svaty == 1){
						/* definovanie parametrov pre modlitbu */
						if(query_type != PRM_DETAILY)
							set_spolocna_cast(sc, poradie_svaty);
				...
				case 5: /* MES_JAN */
					if((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_CSSR)){
						...
						mystrcpy(_global_svaty1.meno, text_JAN_05[_global_jazyk], MENO_SVIATKU);
				...
				case 7: /* MES_JAN */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						_global_svaty2.smer = 11; /* povinne spomienky podla vseobecneho kalendara - zmenenÈ na miestne povinne spomienky podla vseobecneho kalendara */
				...
				case 14: /* MES_JAN */
					if((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_CSSR)){
						...
						_global_svaty1.typslav = SLAV_SPOMIENKA;
						_global_svaty1.smer = 10; /* mieste povinnÈ spomienky podæa miestneho kalend·ra; technicky 10, hoci podæa smernÌc 11 */
						mystrcpy(_global_svaty1.meno, text_JAN_14[_global_jazyk], MENO_SVIATKU);
				...
				case 15: /* MES_JAN */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						_global_svaty1.typslav = SLAV_SPOMIENKA;
						_global_svaty1.smer = 11; /* povinne spomienky podla vseobecneho kalendara - zmenenÈ na miestne povinne spomienky podla vseobecneho kalendara */
						...
						mystrcpy(_global_svaty1.meno, text_JAN_15_1[_global_jazyk], MENO_SVIATKU);
				...
				case 19: /* MES_JAN */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						_global_svaty1.typslav = SLAV_LUB_SPOMIENKA;
						_global_svaty1.smer = 12; /* lubovolne spomienky podla vseobecneho kalendara */
						mystrcpy(_global_svaty1.meno, text_JAN_19_1[_global_jazyk], MENO_SVIATKU);
				...
				case 29: /* MES_JAN */
					if((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_SVD)){
						...
						_global_svaty1.typslav = SLAV_SPOMIENKA;
						_global_svaty1.smer = 10; /* mieste povinnÈ spomienky podæa miestneho kalend·ra; technicky 10, hoci podæa smernÌc 11 */
						mystrcpy(_global_svaty1.meno, text_JAN_29[_global_jazyk], MENO_SVIATKU);
						_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_DUCH_PAST_KNAZ, MODL_SPOL_CAST_SV_MUZ_REHOLNIK);
						_global_svaty1.farba = LIT_FARBA_BIELA;
						_global_svaty1.kalendar = KALENDAR_SK_SVD;
					}/* kalend·r pre KALENDAR_SK_SVD */
			...
			switch(den){
				...
				case 4: /* MES_FEB */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						_global_svaty1.smer = 11; /* povinne spomienky podla vseobecneho kalendara - zmenenÈ na miestne povinne spomienky podla vseobecneho kalendara */
						mystrcpy(_global_svaty1.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
						strcat(_global_svaty1.meno, text_FEB_04[_global_jazyk]);
						_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_PANNA, MODL_SPOL_CAST_SV_ZENA_REHOLNIK);
						_global_svaty1.farba = LIT_FARBA_BIELA;
						_global_svaty1.kalendar = KALENDAR_CZ_OP; /* 2010-08-03: pridanÈ */
					}/* czop only */
						...
						_global_svaty1.typslav = SLAV_LUB_SPOMIENKA;
						_global_svaty1.smer = 12; /* lubovolne spomienky podla vseobecneho kalendara */
						mystrcpy(_global_svaty1.meno, text_FEB_04_1[_global_jazyk], MENO_SVIATKU);
						_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_VIAC_MUCENIKOV, MODL_SPOL_CAST_DUCH_PAST_VIACERI);
						_global_svaty1.farba = LIT_FARBA_CERVENA;
						_global_svaty1.kalendar = KALENDAR_SK_SJ;
					}/* kalend·r pre KALENDAR_SK_SJ */
				...
				case 7: /* MES_FEB */
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						mystrcpy(_global_svaty1.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
						strcat(_global_svaty1.meno, text_FEB_07[_global_jazyk]);
				...
				case 12: /* MES_FEB */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						_global_svaty1.smer = 12; /* lubovolne spomienky podla vseobecneho kalendara */
						mystrcpy(_global_svaty1.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
						strcat(_global_svaty1.meno, text_FEB_12[_global_jazyk]);
						_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_DUCH_PAST_KNAZ);
						_global_svaty1.farba = LIT_FARBA_BIELA;
						_global_svaty1.kalendar = KALENDAR_CZ_OP; /* 2010-08-03: pridanÈ */
					}
				...
				case 13: /* MES_FEB */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						_global_svaty1.smer = 11; /* povinne spomienky podla vseobecneho kalendara - zmenenÈ na miestne povinne spomienky podla vseobecneho kalendara */
						mystrcpy(_global_svaty1.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
						strcat(_global_svaty1.meno, text_FEB_13[_global_jazyk]);
						_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_DUCH_PAST_KNAZ);
						_global_svaty1.farba = LIT_FARBA_BIELA;
						_global_svaty1.kalendar = KALENDAR_VSEOBECNY; /* 2010-08-03: pridanÈ */
					}
				...
				case 18: /* MES_FEB */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						_global_svaty1.smer = 12; /* lubovolne spomienky podla vseobecneho kalendara */
						mystrcpy(_global_svaty1.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
						strcat(_global_svaty1.meno, text_FEB_18[_global_jazyk]);
						_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_DUCH_PAST_KNAZ);
						_global_svaty1.farba = LIT_FARBA_BIELA;
						_global_svaty1.kalendar = KALENDAR_CZ_OP; /* 2010-08-03: pridanÈ */
					}
			...
			switch(den){
				...
				case 8: /* MES_MAR */
					...
					if(_global_jazyk == JAZYK_SK){ /* 2010-03-16: pridanÈ len pre Slovensko */
						...
						mystrcpy(_global_svaty2.meno, text_MAR_08_2[_global_jazyk], MENO_SVIATKU);
				...
				case 15: /* MES_MAR */
					...
					if((_global_den.denvt == DEN_SOBOTA) && (_global_den.rok == 2008)){
						...
						mystrcpy(_global_svaty1.meno, text_MAR_15[_global_jazyk], MENO_SVIATKU);
						_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_SV_MUZ_REHOLNIK, MODL_SPOL_CAST_DUCH_PAST_KNAZ);
						_global_svaty1.farba = LIT_FARBA_BIELA;
						_global_svaty1.kalendar = KALENDAR_SK_CSSR;
					}/* kalend·r pre KALENDAR_SK_CSSR */
			...
			switch(den){
				...
				case 28: /* MES_APR */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						_global_svaty3.smer = 11; /* povinne spomienky podla vseobecneho kalendara - zmenenÈ na miestne povinne spomienky podla vseobecneho kalendara */
			...
			switch(den){
				...
				case 10: /* MES_MAY */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						/* 2009-07-10: odvetvenÈ pre dominik·nov */
						mystrcpy(_global_svaty1.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
						strcat(_global_svaty1.meno, text_MAJ_10[_global_jazyk]);
						_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_DUCH_PAST_BISKUP);
						_global_svaty1.farba = LIT_FARBA_BIELA;
						_global_svaty1.kalendar = KALENDAR_CZ_OP; /* 2010-08-03: pridanÈ */
					}
				...
				case 15: /* MES_MAY */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						_global_svaty1.smer = 11; /* povinne spomienky podla vseobecneho kalendara - zmenenÈ na miestne povinne spomienky podla vseobecneho kalendara */
						mystrcpy(_global_svaty1.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
						strcat(_global_svaty1.meno, text_MAJ_15[_global_jazyk]);
						_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_PANNA_MARIA);
						_global_svaty1.farba = LIT_FARBA_BIELA;
						_global_svaty1.kalendar = KALENDAR_CZ_OP; /* 2010-08-03: pridanÈ */
					}
				...
				case 24: /* MES_MAY */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						_global_svaty1.smer = 11; /* povinne spomienky podla vseobecneho kalendara - zmenenÈ na miestne povinne spomienky podla vseobecneho kalendara */
						mystrcpy(_global_svaty1.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
						strcat(_global_svaty1.meno, text_MAJ_24[_global_jazyk]);
						_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_DUCH_PAST_KNAZ);
						_global_svaty1.farba = LIT_FARBA_BIELA;
						_global_svaty1.kalendar = KALENDAR_CZ_OP; /* 2010-08-03: pridanÈ */
					}
				...
				case 30: /* MES_MAY */
					...
					if((_global_jazyk == JAZYK_CZ) || (_global_jazyk == JAZYK_CZ_OP)){
						...
						_global_svaty1.typslav = SLAV_SPOMIENKA;
						_global_svaty1.smer = 10; /* povinne spomienky podla vseobecneho kalendara */
						mystrcpy(_global_svaty1.meno, text_MAJ_30[(_global_jazyk == JAZYK_CZ_OP)? JAZYK_CZ: _global_jazyk], MENO_SVIATKU);
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						_global_svaty2.smer = 7; /* sviatky preblahoslavenej Panny Marie a svatych, uvedene vo vseobecnom kalendari */
						mystrcpy(_global_svaty2.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
						strcat(_global_svaty2.meno, text_MAJ_30[_global_jazyk]);
			...
			switch(den){
				...
				case 4: /* MES_JUN */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						_global_svaty1.smer = 11; /* povinne spomienky podla vseobecneho kalendara - zmenenÈ na miestne povinne spomienky podla vseobecneho kalendara */
						mystrcpy(_global_svaty1.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
						strcat(_global_svaty1.meno, text_JUN_04[_global_jazyk]);
						_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_MUCENIK, MODL_SPOL_CAST_DUCH_PAST_KNAZ);
						_global_svaty1.farba = LIT_FARBA_CERVENA;
						_global_svaty1.kalendar = KALENDAR_CZ_OP; /* 2010-08-03: pridanÈ */
					}
				...
				case 8: /* MES_JUN */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						_global_svaty1.smer = 12; /* lubovolne spomienky podla vseobecneho kalendara */
						mystrcpy(_global_svaty1.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
						strcat(_global_svaty1.meno, text_JUN_08[_global_jazyk]);
				...
				case 10: /* MES_JUN */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						_global_svaty1.smer = 12; /* lubovolne spomienky podla vseobecneho kalendara */
						mystrcpy(_global_svaty1.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
						strcat(_global_svaty1.meno, text_JUN_10[_global_jazyk]);
						_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_DUCH_PAST_BISKUP);
						_global_svaty1.farba = LIT_FARBA_BIELA;
						_global_svaty1.kalendar = KALENDAR_CZ_OP; /* 2010-08-03: pridanÈ */
					}
				...
				case 27: /* MES_JUN */
					if((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_CSSR)){
						...
						_global_svaty1.typslav = SLAV_SVIATOK;
						_global_svaty1.smer = 8; /* miestne sviatky */
						mystrcpy(_global_svaty1.meno, text_JUN_27_2[_global_jazyk], MENO_SVIATKU);
						_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_PANNA_MARIA);
						_global_svaty1.farba = LIT_FARBA_BIELA;
						_global_svaty1.kalendar = KALENDAR_SK_CSSR;
					}/* kalend·r pre KALENDAR_SK_CSSR */
				...
				case 30: /* MES_JUN */
					...
					if((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_CSSR)){
						...
						mystrcpy(_global_svaty2.meno, text_JUN_30_2[_global_jazyk], MENO_SVIATKU);
						_global_svaty2.spolcast = _encode_spol_cast(MODL_SPOL_CAST_DUCH_PAST_KNAZ, MODL_SPOL_CAST_SV_MUZ_REHOLNIK);
						_global_svaty2.farba = LIT_FARBA_BIELA;
			...
			switch(den){
				...
				case 4: /* MES_JUL */
					if(_global_jazyk == JAZYK_SK){
						...
						mystrcpy(_global_svaty1.meno, text_JUL_04_1[_global_jazyk], MENO_SVIATKU);
						_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_DUCH_PAST_BISKUP);
						_global_svaty1.farba = LIT_FARBA_BIELA; /* 2006-08-19: pridanÈ */
						_global_svaty1.kalendar = KALENDAR_VSEOBECNY_CZ; /* 2010-08-03: pridanÈ */
						pocet = 2;
				...
				case 5: /* MES_JUL */
					if((_global_jazyk == JAZYK_SK) || (_global_jazyk == JAZYK_CZ) || (_global_jazyk == JAZYK_CZ_OP)){
						_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_APOSTOL);
						_global_opt3 = _decode_spol_cast(_global_svaty1.spolcast).a1; /* 2010-07-06: doplnenÈ */
						_global_svaty1.typslav = SLAV_SLAVNOST;
				...
				case 6: /* MES_JUL */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						_global_svaty2.smer = 12; /* lubovolne spomienky podla vseobecneho kalendara */
						mystrcpy(_global_svaty2.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
						strcat(_global_svaty2.meno, text_JUL_06_2[_global_jazyk]);
						_global_svaty2.spolcast = _encode_spol_cast(MODL_SPOL_CAST_SV_MUZ);
						_global_svaty2.farba = LIT_FARBA_BIELA;
						_global_svaty1.kalendar = KALENDAR_CZ_OP; /* 2010-08-03: pridanÈ */
					}/* czop only */
				...
				case 9: /* MES_JUL */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						_global_svaty2.smer = 11; /* povinne spomienky podla vseobecneho kalendara - zmenenÈ na miestne povinne spomienky podla vseobecneho kalendara */
						mystrcpy(_global_svaty2.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
						strcat(_global_svaty2.meno, text_JUL_09_2[_global_jazyk]);
				...
				case 17: /* MES_JUL */
					if(_global_jazyk == JAZYK_SK){
						...
						if(_global_jazyk == JAZYK_CZ_OP){
							...
							_global_svaty2.smer = 11; /* povinne spomienky podla vseobecneho kalendara - zmenenÈ na miestne povinne spomienky podla vseobecneho kalendara */
							mystrcpy(_global_svaty2.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
							strcat(_global_svaty2.meno, text_JUL_17_3[_global_jazyk]);
							_global_svaty2.spolcast = _encode_spol_cast(MODL_SPOL_CAST_DUCH_PAST_KNAZ);
							_global_svaty2.farba = LIT_FARBA_BIELA;
							_global_svaty2.kalendar = KALENDAR_CZ_OP; /* 2010-08-03: pridanÈ */
						}/* czop only */
				...
				case 20: /* MES_JUL */
					...
					if(poradie_svaty == 1){
						...
						modlitba = MODL_POSV_CITANIE;
						if(_global_jazyk == JAZYK_CZ){
							/* 2010-07-19: pre Ëesk˝ mi dodali ËtenÌ */
							_vlastna_cast_2citanie;
						}
						_vlastna_cast_modlitba;
						modlitba = MODL_VESPERY;
			...
			switch(den){
				case 1: /* MES_AUG */
					if((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_CSSR)){
						...
						_global_svaty1.typslav = SLAV_SLAVNOST;
						_global_svaty1.smer = 3; /* miestne sl·vnosti podæa miestneho kalend·ra; pouûitÈ z technick˝ch dÙvodov 3, hoci podæa smernÌc je 4 */
						mystrcpy(_global_svaty1.meno, text_AUG_01_1[_global_jazyk], MENO_SVIATKU);
						_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_DUCH_PAST_BISKUP, MODL_SPOL_CAST_UCITEL_CIRKVI);
						_global_svaty1.farba = LIT_FARBA_BIELA;
						_global_svaty1.kalendar = KALENDAR_SK_CSSR;
					}/* kalend·r pre KALENDAR_SK_CSSR */
				...
				case 2: /* MES_AUG */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						_global_svaty3.smer = 12; /* lubovolne spomienky podla vseobecneho kalendara */
						mystrcpy(_global_svaty3.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
						strcat(_global_svaty3.meno, text_AUG_02_3[_global_jazyk]);
				...
				case 17: /* MES_AUG */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						_global_svaty1.smer = 11; /* povinne spomienky podla vseobecneho kalendara - zmenenÈ na miestne povinne spomienky podla vseobecneho kalendara */
						mystrcpy(_global_svaty1.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
						strcat(_global_svaty1.meno, text_AUG_17[_global_jazyk]);
						_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_DUCH_PAST_KNAZ);
						_global_svaty1.farba = LIT_FARBA_BIELA;
						_global_svaty1.kalendar = KALENDAR_CZ_OP; /* 2010-08-03: pridanÈ */
					}/* czop only */
				...
				case 18: /* MES_AUG */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						_global_svaty1.smer = 12; /* lubovolne spomienky podla vseobecneho kalendara */
						mystrcpy(_global_svaty1.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
						strcat(_global_svaty1.meno, text_AUG_18[_global_jazyk]);
						_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_DUCH_PAST_KNAZ);
						_global_svaty1.farba = LIT_FARBA_BIELA;
						_global_svaty1.kalendar = KALENDAR_CZ_OP; /* 2010-08-03: pridanÈ */
					}/* czop only */
			...
			switch(den){
				...
				case 18: /* MES_SEP */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						_global_svaty1.typslav = SLAV_SPOMIENKA;
						_global_svaty1.smer = 11; /* povinne spomienky podla vseobecneho kalendara - zmenenÈ na æubovoæn˙ */
						mystrcpy(_global_svaty1.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
						strcat(_global_svaty1.meno, text_SEP_18[_global_jazyk]);
						_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_SV_MUZ_REHOLNIK);
						_global_svaty1.farba = LIT_FARBA_BIELA;
						_global_svaty1.kalendar = KALENDAR_CZ_OP; /* 2010-08-03: pridanÈ */
					}/* czop only */
				...
				case 26: /* MES_SEP */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						_global_svaty2.smer = 11; /* povinne spomienky podla vseobecneho kalendara - zmenenÈ na miestne povinne spomienky podla vseobecneho kalendara */
						mystrcpy(_global_svaty2.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
						strcat(_global_svaty2.meno, text_SEP_26_2[_global_jazyk]);
						_global_svaty2.spolcast = _encode_spol_cast(MODL_SPOL_CAST_VIAC_MUCENIKOV);
						_global_svaty2.farba = LIT_FARBA_CERVENA; /* 2006-08-19: pridanÈ */
						_global_svaty2.kalendar = KALENDAR_CZ_OP; /* 2010-08-03: pridanÈ */
					}/* czop only */
					...
					if((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_CSSR)){
						...
						_global_svaty2.typslav = SLAV_LUB_SPOMIENKA;
						_global_svaty2.smer = 12; /* mieste æubovoænÈ spomienky podæa miestneho kalend·ra */
						mystrcpy(_global_svaty2.meno, text_SEP_26_1[_global_jazyk], MENO_SVIATKU);
						_global_svaty2.spolcast = _encode_spol_cast(MODL_SPOL_CAST_DUCH_PAST_KNAZ, MODL_SPOL_CAST_SV_MUZ_REHOLNIK);
						_global_svaty2.farba = LIT_FARBA_BIELA;
						_global_svaty2.kalendar = KALENDAR_SK_CSSR;
					}/* kalend·r pre KALENDAR_SK_CSSR */
				...
				case 28: /* MES_SEP */
					if((_global_jazyk == JAZYK_CZ) || (_global_jazyk == JAZYK_CZ_OP)){ /* 2008-10-09: odvetvenÈ len pre »esko; prevzatÈ podæa cyrila a metoda */
						...
						_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_MUCENIK);
						_global_opt3 = MODL_SPOL_CAST_MUCENIK; // 2009-10-27: doplnenÈ, aby sa to mohlo pouûiù v set_spolocna_cast()
						_global_svaty1.typslav = SLAV_SLAVNOST;
						_global_svaty1.smer = 3; /* slavnosti Pana, preblahoslavenej Panny Marie a svatych, uvedene vo vseobecnom kalendari */
			...
			switch(den){
				...
				case 5: /* MES_OCT */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						_global_svaty1.smer = 12; /* lubovolne spomienky podla vseobecneho kalendara */
						mystrcpy(_global_svaty1.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
						strcat(_global_svaty1.meno, text_OKT_05[_global_jazyk]);
						_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_DUCH_PAST_KNAZ);
						_global_svaty1.farba = LIT_FARBA_BIELA;
						_global_svaty1.kalendar = KALENDAR_VSEOBECNY; /* 2010-08-03: pridanÈ */
					}
				...
				case 9: /* MES_OCT */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						_global_svaty3.smer = 11; /* povinne spomienky podla vseobecneho kalendara - zmenenÈ na miestne povinne spomienky podla vseobecneho kalendara */
						mystrcpy(_global_svaty3.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
						strcat(_global_svaty3.meno, text_OKT_09_3[_global_jazyk]);
						_global_svaty3.spolcast = _encode_spol_cast(MODL_SPOL_CAST_DUCH_PAST_KNAZ);
						_global_svaty3.farba = LIT_FARBA_BIELA;
						_global_svaty3.kalendar = KALENDAR_CZ_OP; /* 2010-08-03: pridanÈ */
					}/* czop only */
				...
				case 16: /* MES_OCT */
					if((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_CSSR)){
						...
						_global_svaty1.typslav = SLAV_SPOMIENKA;
						_global_svaty1.smer = 10; /* mieste povinnÈ spomienky podæa miestneho kalend·ra; technicky 10, hoci podæa smernÌc 11 */
						mystrcpy(_global_svaty1.meno, text_OKT_16_3[_global_jazyk], MENO_SVIATKU);
						_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_SV_MUZ_REHOLNIK);
						_global_svaty1.farba = LIT_FARBA_BIELA;
						_global_svaty1.kalendar = KALENDAR_SK_CSSR;
					}/* kalend·r pre KALENDAR_SK_CSSR */
			...
			switch(den){
				...
				case 6: /* MES_NOV */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						_global_svaty1.smer = 11; /* povinne spomienky podla vseobecneho kalendara - zmenenÈ na miestne povinne spomienky podla vseobecneho kalendara */
						mystrcpy(_global_svaty1.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
						strcat(_global_svaty1.meno, text_NOV_06[_global_jazyk]);
						_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_VIAC_MUCENIKOV);
						_global_svaty1.farba = LIT_FARBA_CERVENA;
						_global_svaty1.kalendar = KALENDAR_CZ_OP; /* 2010-08-03: pridanÈ */
					}/* czop only */
				...
				case 7: /* MES_NOV */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						mystrcpy(_global_svaty1.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
						strcat(_global_svaty1.meno, text_NOV_07[_global_jazyk]);
						_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_NEBRAT);
						_global_svaty1.farba = LIT_FARBA_BIELA;
						_global_svaty1.kalendar = KALENDAR_CZ_OP; /* 2010-08-03: pridanÈ */
					}/* czop only */
				...
				case 8: /* MES_NOV */
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						_global_svaty1.smer = 12;
						mystrcpy(_global_svaty1.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
						strcat(_global_svaty1.meno, text_NOV_08[_global_jazyk]);
						_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_ZA_ZOSNULYCH);
				...
				case 25: /* MES_NOV */
					...
					if(poradie_svaty == 1){
						...
						modlitba = MODL_POSV_CITANIE;
						_vlastna_cast_modlitba;
						if((_global_jazyk == JAZYK_SK) || (_global_jazyk == JAZYK_CZ_OP)){ /* 2010-11-29: odvetvenÈ pre Slovensko a czop */
							_vlastna_cast_2citanie;
						}
...
#define _srdca_pm_2cit {\
	...
	if((_global_den.denvr == (_global_r._ZOSLANIE_DUCHA_SV.denvr + 20)) && 
		 ...
		 */
		mystrcpy(_global_svaty1.meno, "NepoökvrnenÈho Srdca Panny M·rie", MENO_SVIATKU);
		_global_svaty1.spolcast =
