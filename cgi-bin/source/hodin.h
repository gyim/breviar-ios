...
, {"ranné chvály", "ranní chvály", "Laudes", "laudes matutinae", "" }
...
, {"kompletórium po prvıch vešperách", "kompletáø po prvních nešporech", "1st Completary", "I completorio", "" } /* 2007-12-05: zmenené, kedysi bolo: "prvé kompletórium" */
, {"druhé vešpery", "druhé nešpory", "2nd Vesperae", "II vesper&#230;", "" }
, {"kompletórium po druhıch vešperách", "kompletáø po druhıch nešporech", "2nd Completary", "II completorio", "" } /* 2007-12-05: zmenené, kedysi bolo: "druhé kompletórium" */
...
, {"Prvé vešpery", "První nešpory", "1st Vesperae", "I Vesper&#230;", "" }
, {"Kompletórium po prvıch vešperách", "Kompletáø po prvních nešporech", "1st Completary", "I Completorio", "" }
, {"Druhé vešpery", "Druhé nešpory", "2nd Vesperae", "II Vesper&#230;", "" }
, {"Kompletórium po druhıch vešperách", "Kompletáø po druhıch nešporech", "2nd Completary", "II Completorio", "" }
, {"Detaily", "Detaily", "Details", "Details", "" }
};
...
{{"vo ve¾konoènej oktáve", "ve velikonoèním oktávu", "", "", ""},
 ...
 {"vo vianoènom období", "v dobì vánoèní", "", "", ""},
 {"v cezroènom období", "v mezidobí", "", "per annum", ""}, // obdobie „cez rok“
...
{{"___", "___", "___", "___", ""}, 
 {"èervená", "èervená", "red", "rosa", ""}, 
 {"biela", "bílá", "white", "alba", ""}, 
 {"zelená", "zelená", "green", "___", ""}, 
 {"fialová", "fialová", "purple", "___", ""}, 
 {"ruová", "rùová", "rose", "___", ""}, 
};
...
{ {"nede¾a", "nedìle", "Sunday", "domínica", ""}
, {"pondelok" , "pondìlí", "Monday", "feria secúnda", ""}
, {"utorok" , "úterı", "Tuesday", "feria tértia", ""}
, {"streda" , "støeda", "Wednesday", "feria quarta", ""}
, {"štvrtok" , "ètvrtek", "Thursday", "feria quinta", ""}
, {"piatok" , "pátek", "Friday", "feria sexta", ""}
, {"sobota" , "sobota", "Saturday", "sábbatum", ""}
...
{ {"nedela", "nedele", "Sunday", "Dominica", ""}
, {"pondelok" , "pondeli", "Monday", "Feria secunda", ""}
, {"utorok" , "utery", "Tuesday", "Feria tertia", ""}
, {"streda" , "streda", "Wednesday", "Feria quarta", ""}
, {"stvrtok" , "ctvrtek", "Thursday", "Feria quinta", ""}
, {"piatok" , "patek", "Friday", "Feria sexta", ""}
, {"sobota" , "sobota", "Saturday", "Sabbatum", ""}
...
{ {"NEDE¼A", "NEDÌLE", "SUNDAY", "DOMÍNICA", ""}
, {"PONDELOK" , "PONDÌLÍ", "MONDAY", "FERIA SECÚNDA", ""}
, {"UTOROK" , "ÚTERİ", "TUESDAY", "FERIA TÉRTIA", ""}
, {"STREDA" , "STØEDA", "WEDNESDAY", "FERIA QUARTA", ""}
, {"ŠTVRTOK" , "ÈTVRTEK", "THURSDAY", "FERIA QUINTA", ""}
, {"PIATOK" , "PÁTEK", "FRIDAY", "FERIA SEXTA", ""}
, {"SOBOTA" , "SOBOTA", "SATURDAY", "SÁBBATUM", ""}
...
{ {"január", "leden", "January", "ianuárius", ""}
...
const char *nazov_Mesiaca_jazyk[POCET_MESIACOV + 1][POCET_JAZYKOV + 1] = 
{ {"Január", "Leden", "January", "Ianuárius", ""}
, {"Február" , "Únor", "February", "Februárius", ""}
, {"Marec", "Bøezen", "March", "Mártius", ""}
, {"Apríl" , "Duben", "April", "Aprílis", ""}
, {"Máj" , "Kvìten", "May", "Maius", ""}
, {"Jún" , "Èerven", "June", "Iúnius", ""}
, {"Júl" , "Èervenec", "July", "Iúlius", ""}
, {"August" , "Srpen", "August", "Augústus", ""}
, {"September" , "Záøí", "September", "Septémber", ""}
, {"Október" , "Øíjen", "October", "Octóber", ""}
, {"November" , "Listopad", "November", "Novémber", ""}
, {"December" , "Prosinec", "December", "Decémber", ""}
, {"Neznámy" , "Neznámı", "unknown", "???", ""}
};
...
{ {"januára", "ledna", "January", "ianuárii", ""}
, {"februára" , "února", "February", "februárii", ""}
, {"marca" , "bøezna", "March", "mártii", ""}
, {"apríla" , "dubna", "April", "aprílis", ""}
, {"mája" , "kvìtna", "May", "maii", ""}
, {"júna" , "èervna", "June", "iúnii", ""}
, {"júla" , "èervence", "July", "iúlii", ""}
, {"augusta" , "srpna", "August", "augústi", ""}
, {"septembra" , "záøí", "September", "septémbris", ""}
, {"októbra" , "øíjna", "October", "octóbris", ""}
, {"novembra" , "listopadu", "November", "novémbris", ""}
, {"decembra" , "prosince", "December", "decémbris", ""}
, {"neznámeho" , "neznámého", "unknown", "___", ""}
};
...
{"slovenèina", "èeština", "English", "lingua latina", "(neurèenı)"};
...
const char *html_button_kompletorium[] = {"Kompl.", "Kompl.", "Compl.", "Compl.", ""};
...
const char *html_button_det_defaults[] = {"Pôvodné hodnoty", "Pùvodní hodnoty", "Defaults", "___", ""};
#ifndef HTML_BUTTON_DET_DEFAULTS
#define HTML_BUTTON_DET_DEFAULTS	html_button_det_defaults[_global_jazyk]
#endif

const char *html_button_dnes_show[] = {"Zobraz", "Uka", "Show", "___", ""};
...
const char *html_text_den[] = {"deò", "den", "day", "die", ""};
const char *html_text_mesiac[] = {"mesiac", "mìsíc", "month", "(mesiac)", ""};
...
const char *html_text_dnesok[] = {"dnešok", "dnešní den", "today", "hódie", ""};
...
const char *html_text_zakladne_info[] = {"Základné informácie", "Základní informace", "Basic info", "__info__", ""};
const char *html_text_je[] = {"je", "je", "is", "est", ""};
const char *html_text_nie_je[] = {"nie je", "není", "is not", "non est", ""};
...
const char *str_modl_cez_den_zalmy_zo_dna[POCET_JAZYKOV + 1] = 
	{"benej psalmódie", "bìné psalmodie", "ordinary psalmody", "___", ""};
...
const char *str_modl_cez_den_doplnkova_psalmodia[POCET_JAZYKOV + 1] = 
	{"doplnkovej psalmódie", "doplòkové psalmodie", "supplementary psalmody", "psalmodia complementaris", ""};
...
const char *str_modl_zalmy_zo_sv[POCET_JAZYKOV + 1] = 
	{"sviatku", "svátku", "celebration", "___", ""};
...
{"Sv. Augustína Zhao Rong, kòaza, a spoloèníkov, muèeníkov",
 "Sv. Augustina ao Ronga, knìze a jeho druhù, mùèedníkù",
 "", "", ""};
