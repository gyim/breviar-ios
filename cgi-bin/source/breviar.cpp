...
/* ------------------------------------------- */
	...
	if(_global_jazyk == JAZYK_SK){
		...
		// 2011-04-13: upravenie exportu
		// Export("<br>"); // netreba do novÈho riadka
		// Export("&nbsp;&nbsp;&nbsp;&nbsp;"); // nie je potrebnÈ odsadzovaù (uû tam nie je <ul>)
		/* pole WWW_KALENDAR */
		...
		Export("&nbsp;");
		Export((char *)html_text_kalendar_miestny_explain[_global_jazyk]);
		Export("</span>");
		*/
	...
	if((typ != EXPORT_DNA_VIAC_DNI) && (typ != EXPORT_DNA_VIAC_DNI_SIMPLE) && (typ != EXPORT_DNA_VIAC_DNI_TXT)){
		...
		if((_global_linky == ANO) || ((_global_opt_batch_monthly == ANO) && (export_monthly_druh >= 2))){ /* pridane 13/04/2000A.D.; upravenÈ 2009-08-12 */
			...
			if((_global_opt_batch_monthly == ANO) && (export_monthly_druh > 2)
				...
				){ /* 2009-08-26: doplnenÈ; 2011-04-13: postaËuje, aby to bolo na viac ako jeden deÚ, uû sa kalend·r nevypisuje; podmienka aj hore (tu je prakticky zbytoËn·) */
