			...
			if(batch_file != NULL){
				...
				if(batch_html_file != NULL){
					...
					if(_global_opt_batch_monthly == ANO){
						...
						fprintf(batch_html_file, "<!-- Odkazy na dneön˝ deÚ (DneönÈ modlitby) a Prehæad mesiaca vyûaduj˙ JavaScript. JavaScript funkcia (c) 2009 Peter Sahajda; upravil (c) 2010 Juraj VidÈky -->\n");
						...
						fprintf(batch_html_file, "\n");
						fprintf(batch_html_file, "output = output + '<ul><li> '+tag1+cestax+'>DneönÈ modlitby ('+den+'. '+mesiac+'. 20'+rok+')'+tag2+'<br></li>';\n");
						fprintf(batch_html_file, "\n");
						fprintf(batch_html_file, "output = output + '<li>'+tag1+cesta_mesiac+'>Prehæad mesiaca ('+mesiac+'/20'+rok+')'+tag2+'</li></ul>';\n");
						fprintf(batch_html_file, "\n");
