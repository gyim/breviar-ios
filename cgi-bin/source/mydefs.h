...
#define MAX_GLOBAL_STR		360 /* _global_string; 31/03/2000A.D.; 2010-12-07: rozöÌrenÈ */
#define MAX_GLOBAL_STR2		20 /* _global_string2, pridanÈ 2006-08-19 */
#define MAX_GLOBAL_STR_FARBA 150 /* _global_string_farba, pridanÈ 2006-08-19 */
...
/* definÌcie HTML prvkov upravenÈ a presunutÈ do hodin.h, 2006-08-01;
 * tu ponechanÈ len z historick˝ch dÙvodov zakomentovanÈ
 * -- pridane 2003-07-15 
 * #define HTML_BUTTON_RANNE_CHVALY "RannÈ chv·ly"
 * #define HTML_BUTTON_PREDPOLUDNIM "9h"
 * #define HTML_BUTTON_NAPOLUDNIE   "12h"
 * #define HTML_BUTTON_POPOLUDNI    "15h"
 * #define HTML_BUTTON_VESPERY      "Veöpery"
 * -- dalsie pridane 2003-08-06 
 * #define HTML_BUTTON_POSV_CITANIE "Posv.ËÌt."
 * #define HTML_BUTTON_DETAILY      "Detaily..."
 * #define HTML_BUTTON_DET_SHOW     "Zobraz modlitbu"
 * #define HTML_BUTTON_DET_DEFAULTS "PÙvodnÈ hodnoty"
 * -- pridanÈ 2003-08-07 
 * #define HTML_BUTTON_DNES_SHOW     "Zobraz"
 * #define HTML_BUTTON_DNES_DEFAULTS "VyËisti"
 */
